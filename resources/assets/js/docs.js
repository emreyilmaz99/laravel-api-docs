...
document.getElementById('searchInput').addEventListener('input', function(e) {
    ...
    endpoints.forEach(el => {
        ...
        const params = (el.dataset.params || '').toLowerCase();

        if (uri.includes(query) || method.includes(query) || text.includes(query) || description.includes(query) || params.includes(query)) {
            el.style.display = '';
